      ...
      <div className="container mx-auto px-4 py-16 max-w-5xl">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          <Link href="/import" className="group">
            <div className="tech-card p-8 h-full hover:border-cyan-300 group-hover:-translate-y-1 transition-all duration-300">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-cyan-100 rounded-lg flex items-center justify-center group-hover:bg-cyan-200 transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-cyan-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" />
                  </svg>
                </div>
                <div>
                  <h3 className="text-xl font-semibold text-slate-900 mb-2">Import Journal with AI</h3>
                  <p className="text-slate-600">Bulk import and categorize journal entries.</p>
                </div>
              </div>
            </div>
          </Link>
